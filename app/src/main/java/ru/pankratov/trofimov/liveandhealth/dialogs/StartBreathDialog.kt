...
class StartBreathDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.start_breath_dialog_layout, container)
    ...
    private fun startExerciseTimer(textNumber: TextView) {
        timer = object : CountDownTimer(TIME_START, 1000) {
            ...
            override fun onFinish() {
                dismiss()
                (activity as BreathActivity).start()
            }
        }
